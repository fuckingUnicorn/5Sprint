...
func (w Walking) Calories() float64 {
	...
	meanSpeedInMInSec := math.Pow(w.meanSpeed()*KmHInMsec, 2)
	return (CaloriesWeightMultiplier*w.Weight + (meanSpeedInMInSec/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight)
}
